...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('employee_id_settings', function (Blueprint $table) {
            ...
            $table->string('card_width')->default('85.6');
            $table->string('card_height')->default('54');
            ...
            $table->string('qr_code_size')->default('80');
            $table->boolean('include_photo')->default(true);
            $table->string('photo_position')->default('top-right');
            $table->string('photo_size')->default('100');

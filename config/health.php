...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('HEALTH_ALERT_EMAIL', env('MAIL_FROM_ADDRESS', 'hello@example.com')),
        ...
        'slack' => [
            ...
            'channel' => env('HEALTH_SLACK_CHANNEL'),
    ...
    /*
     * The application name that will be displayed on the health check results page
     */

...
class LandlordInvoiceTerminated extends Notification
{
    use Queueable;
    ...
    public function toSms(object $notifiable): string
    {
        ...
        return __('Tenant :tenant terminated. Invoice :number still unpaid. Balance $:amount.', [
    ...
    public function toSlack(object $notifiable): SlackMessage
    {
        ...
        return (new SlackMessage())
            ->error()
            ->content(__('Tenant terminated for overdue invoice :number.', ['number' => $invoice->invoice_number]))
    ...
    public function toWebhook(object $notifiable): array
    {
        ...
        return [
            'event' => 'billing.invoice.terminated',
            'invoice' => [
                'id' => $invoice->getKey(),
                'number' => $invoice->invoice_number,

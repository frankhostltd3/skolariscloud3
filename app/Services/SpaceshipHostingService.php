...
class SpaceshipHostingService
{
    protected string $apiKey;
    protected string $apiUser;
    protected string $apiUrl = 'https://api.spaceship.com/v1';
    ...
    public function getPlans(): array
    {
        try {
            ...
            Log::error('Spaceship get plans failed', ['error' => $e->getMessage()]);
            return [];
        }
    }
    ...
    public function provisionHosting(array $data): array
    {
        try {
            ...
            Log::error('Spaceship hosting provision failed', [
                'domain' => $data['domain'],
                'error' => $e->getMessage(),
            ]);

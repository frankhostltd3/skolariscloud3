        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">Review upcoming events, maintenance requests, and bulletin updates.</p>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">Track administrative workflows and collaborate with other departments.</p>

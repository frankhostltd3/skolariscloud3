    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <p class="lead mb-4">Streamline operations, enhance learning, and empower your institution with our comprehensive school management system.</p>
            ...
            <div class="col-lg-6">
                <img src="https://via.placeholder.com/600x400/667eea/ffffff?text=School+Dashboard" alt="Dashboard" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-md-3">
                <h2 class="display-4 fw-bold" style="color: var(--primary-color);">4.9/5</h2>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm" style="transition: transform 0.3s;">
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <i class="bi bi-calendar-check fs-1" style="color: var(--secondary-color);"></i>
                        </div>
                        <h3 class="h4 fw-bold mb-3">Attendance & Timetable</h3>
                        <p class="text-muted">Digital attendance tracking and smart timetable generation with conflict detection.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm" style="transition: transform 0.3s;">
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <i class="bi bi-cash-stack fs-1" style="color: var(--primary-color);"></i>
                        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm" style="transition: transform 0.3s;">
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <i class="bi bi-chat-dots fs-1" style="color: var(--secondary-color);"></i>
                        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm" style="transition: transform 0.3s;">
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <i class="bi bi-graph-up fs-1" style="color: var(--accent-color);"></i>
                        </div>
...
<section id="pricing" class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="card h-100 border-0 shadow" style="transform: scale(1.05); border: 3px solid var(--primary-color) !important;">
                    <div class="card-body p-4">
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Up to 1000 students</li>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-4">"SMATCAMPUS has revolutionized how we manage our school. The interface is intuitive and the support team is exceptional."</p>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-4">"The automation features saved us countless hours. Parent communication has never been easier!"</p>
                        <div class="d-flex align-items-center">
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-4">"Outstanding platform! The analytics help us make informed decisions about our academic programs."</p>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="accordion-item border-0 mb-3 shadow-sm">
                        ...
                        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                You can start using SMATCAMPUS immediately after signup. Our team will help you import your existing data and train your staff within days.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0 mb-3 shadow-sm">
                        ...
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Absolutely! We use bank-level encryption, regular backups, and comply with international data protection standards including GDPR.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0 mb-3 shadow-sm">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes! Our system is highly customizable. You can configure workflows, reports, and even request custom features for Enterprise plans.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0 mb-3 shadow-sm">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                We provide email support for all plans, priority support for Professional, and 24/7 dedicated support for Enterprise customers.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0 mb-3 shadow-sm">

        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <p class="text-muted">Empowering schools with intelligent management solutions. Transform your institution with our comprehensive platform.</p>
                    <div class="mt-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <p class="text-muted mb-0">Made with <i class="bi bi-heart-fill text-danger"></i> for Education</p>
                </div>
            </div>
        </div>
    </footer>

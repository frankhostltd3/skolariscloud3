                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form method="POST" action="{{ route('settings.mail.update') }}" novalidate>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select @error('mailer') is-invalid @enderror" id="mailer"
                                        name="mailer" data-mailer-selector>
                                        @foreach ($mailers as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ $currentMailer === $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                id="mailgun_secret" name="mailgun_secret"
                                                value="{{ old('mailgun_secret') }}"
                                ...
                                <div class="mailer-settings" data-mailer-section="ses-v2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                class="form-control @error('ses_key') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                class="form-control @error('ses_secret') is-invalid @enderror"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                class="form-control @error('ses_region') is-invalid @enderror"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                id="postmark_token" name="postmark_token"
                                                value="{{ old('postmark_token') }}"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                id="resend_api_key" name="resend_api_key"
                                                value="{{ old('resend_api_key') }}"
                                                placeholder="Leave blank to keep existing key">

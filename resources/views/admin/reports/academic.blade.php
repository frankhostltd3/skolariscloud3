                ...
                <div class="d-flex gap-2">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#" onclick="exportReport(); return false;">Export PDF</a></li>
                            <li><a class="dropdown-item" href="#" onclick="exportReportCsv(); return false;">Export CSV</a></li>
                            <li><a class="dropdown-item" href="#" onclick="exportReportXlsx(); return false;">Export Excel (XLSX)</a></li>
                        </ul>
                    </div>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-select" id="grade_level" name="grade_level">
                            ...
                            <option value="{{ $label }}" {{ request('grade_level')===$label ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3 mb-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <canvas id="gradeDistributionChart" width="400" height="200" aria-label="Stacked grade distribution by subject" role="img"
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    @if(empty($subjectPerformance))
                        <p class="text-muted mb-0 small">No subject performance data found for the selected filters.</p>
                    @else
                        @foreach($subjectPerformance as $subject)
                            <div class="mb-3">
                                ...
                                <div class="progress" style="height: 8px;" aria-hidden="true">
                                    <div class="progress-bar bg-success subject-avg-bar" data-width="{{ $subject['average'] }}" style="width:0%"></div>
                                </div>
                            </div>
                        @endforeach
                    @endif
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <canvas id="classPerformanceChart" width="400" height="300" aria-label="Average performance by class" role="img"
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <canvas id="trendsChart" width="400" height="150" aria-label="GPA trend over months" role="img"
                        data-months="{{ e(json_encode($months ?? [])) }}"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="report_description" name="description" rows="3" placeholder="Add any specific notes or requirements for this report..."></textarea>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // Guard if no data
    if(!subjectLabels.length){ gradeCanvas.replaceWith(Object.assign(document.createElement('div'),{className:'text-muted small',innerText:'No grade data available.'})); }
    if(!classLabels.length){ classCanvas.replaceWith(Object.assign(document.createElement('div'),{className:'text-muted small',innerText:'No class performance data.'})); }
    if(!months.length){ trendsCanvas.replaceWith(Object.assign(document.createElement('div'),{className:'text-muted small',innerText:'No trend data.'})); }

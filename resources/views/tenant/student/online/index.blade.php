                            ...
                            <form method="GET" class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="platform" class="form-select">
                                        ...
                                        <option value="zoom"
                                            {{ ($filters['platform'] ?? '') == 'zoom' ? 'selected' : '' }}>Zoom</option>
                                        <option value="google_meet"
                                            {{ ($filters['platform'] ?? '') == 'google_meet' ? 'selected' : '' }}>Google
                                            Meet</option>
                                        <option value="microsoft_teams"
                                            {{ ($filters['platform'] ?? '') == 'microsoft_teams' ? 'selected' : '' }}>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div class="small text-muted mb-2">
                                                                @if ($class->subject)
                                                                    <span class="me-3">
                                                                        <i
                                                                            class="bi bi-book me-1"></i>{{ $class->subject->name }}
                                                                    </span>
                                                                @endif
                                                                @if ($class->teacher)
                                                                    <span class="me-3">
                                                                        <i
                                                                            class="bi bi-person me-1"></i>{{ $class->teacher->name }}
                                                                    </span>
                                                                @endif
                                                                <span
                                                                    class="badge bg-{{ $class->status === 'live' ? 'danger' : 'primary' }}">
                                                                    @if ($class->status === 'live')
                                                                        <i
                                                                            class="bi bi-record-circle me-1"></i>{{ __('LIVE NOW') }}
                                                                    @else
                                                            ...
                                                            @if ($class->description)
                                                                <p class="mb-0 small">
                                                                    {{ Str::limit($class->description, 100) }}</p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 text-md-end mt-3 mt-md-0">
                                                    @if ($class->can_join)
                                                        <a href="{{ route('tenant.student.online-classes.join', $class->id) }}"
                                                            class="btn btn-success btn-sm w-100">
                                                            <i
                                                                class="bi bi-box-arrow-up-right me-1"></i>{{ __('Join Now') }}
                                                        </a>
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted mt-3 mb-0">{{ __('No upcoming online classes at the moment.') }}
                                    </p>
                                    <small
                                        class="text-muted">{{ __('Check back later or contact your teacher.') }}</small>
                                </div>
                            @endif
                        </div>
                    </div>

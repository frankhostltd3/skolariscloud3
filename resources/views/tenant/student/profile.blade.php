                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" value="{{ optional($student->classroom ?? null)->name ?? '—' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control"
                                    value="{{ optional($student->classroom->teacher ?? null)->name ?? '—' }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" value="{{ optional($student)->guardian_name ?? '—' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Guardian Contact</label>
                                <input class="form-control" value="{{ optional($student)->guardian_phone ?? '—' }}"
                                    readonly>
                            </div>
                        </div>
                    </div>

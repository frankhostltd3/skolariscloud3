            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="{{ $statistics['overdue'] > 0 ? 'text-danger' : 'text-secondary' }}" style="font-size: 1.5rem;">
    ...
    @if($myBorrows->count() > 0)
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            <h6 class="alert-heading">
                <i class="bi bi-info-circle me-2"></i>{{ __('You currently have') }} {{ $myBorrows->count() }} {{ __('book(s) borrowed') }}
            </h6>
            <ul class="mb-0 small">
            ...
            <form method="GET" action="{{ route('tenant.student.library.index') }}" class="row g-2">
                <div class="col-12 col-md-5">
                    ...
                    <input type="text" 
                           ...
                           placeholder="{{ __('Search by title, author, ISBN...') }}"
                           value="{{ $search }}">
                </div>
                        ...
                        <div class="card-body p-2 d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="d-grid gap-1">
                                    ...
                                    @if($book->isAvailable())
                                        <form method="POST" action="{{ route('tenant.student.library.borrow', $book->id) }}">
                                            @csrf
                                            <button type="submit" class="btn btn-success btn-sm w-100" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">

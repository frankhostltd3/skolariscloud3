                            ...
                            <div class="mt-4">
                                @if($myActiveBorrow)
                                    <div class="alert alert-info">
                                        ...
                                        <strong>{{ __('Due Date:') }}</strong> {{ $myActiveBorrow->due_date->format('M d, Y') }}
                                    ...
                                    @if($myActiveBorrow->renewal_count < 2 && !$myActiveBorrow->isOverdue())
                                        <form method="POST" action="{{ route('tenant.student.library.extend', $myActiveBorrow->id) }}">
                                            @csrf
                                            <button type="submit" class="btn btn-warning">
                                                <i class="bi bi-arrow-repeat me-2"></i>
                                                {{ __('Request Extension') }}
                                                <small>({{ 2 - $myActiveBorrow->renewal_count }} {{ __('left') }})</small>
                                            </button>
                                        </form>
                                    @endif
                ...
                <div class="card shadow-sm border-info mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-2">
                            ...
                            @else
                                <span class="badge bg-success">{{ $myActiveBorrow->due_date->diffInDays(now()) }} {{ __('days left') }}</span>
                            @endif
                        </p>

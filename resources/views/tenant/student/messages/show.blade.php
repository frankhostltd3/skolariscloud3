        ...
        <div class="row">
            <div class="col-lg-12">
                        ...
                        @foreach ($messages as $message)
                            ...
                            <div class="message-bubble {{ $isSender ? 'message-sent' : 'message-received' }} mb-3">
                                <div class="message-header">
                                    ...
                                    <small
                                        class="text-muted ms-2">{{ $message->created_at->format('M d, Y h:i A') }}</small>
                                </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tenant.student.messages.reply', $thread->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <small
                                    class="text-muted">{{ __('Max 10MB. Allowed: PDF, DOC, DOCX, JPG, PNG, GIF') }}</small>
                                @error('attachment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

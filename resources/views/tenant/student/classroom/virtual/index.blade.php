...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('tenant.student.classroom.virtual.attendance') }}" class="btn btn-outline-primary">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <form action="{{ route('tenant.student.classroom.virtual.index') }}" method="GET"
                        class="d-flex gap-2">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="d-flex align-items-start gap-3 mb-3">
                                            <div
                                                class="bg-{{ $isOngoing ? 'success' : ($isUpcoming ? 'primary' : 'secondary') }} bg-opacity-10 p-3 rounded">
                                                <i
                                                    class="bi bi-camera-video text-{{ $isOngoing ? 'success' : ($isUpcoming ? 'primary' : 'secondary') }} fs-3"></i>
                                            </div>
                                        ...
                                        <div class="d-flex gap-3 flex-wrap">
                                            <small class="text-muted">
                                                ...
                                                {{ optional($class->start_time)->format('M d, Y') ?? 'N/A' }}
                                            </small>
                                            <small class="text-muted">
                                                <i class="bi bi-clock me-1"></i>
                                                {{ optional($class->start_time)->format('h:i A') ?? 'N/A' }} -
                                                {{ optional($class->end_time)->format('h:i A') ?? 'N/A' }}
                                            </small>
                                            <small class="text-muted">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-5">
                    ...
                    @else
                        ...
                        <p class="text-muted">
                            {{ request('search') ? 'Try a different search term.' : 'There are no virtual classes available at the moment.' }}
                        </p>
                    @endif
                </div>
            </div>

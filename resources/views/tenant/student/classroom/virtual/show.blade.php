                    ...
                    @elseif($canJoin && $isUpcoming)
                        <div class="alert alert-primary d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-0">Class starts {{ $class->start_time->diffForHumans() }}. You can join now.</p>
                            </div>
                    ...
                    @elseif($isUpcoming)
                        <div class="alert alert-info d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">This class starts {{ $class->start_time->diffForHumans() }}. Join link will be available 15 minutes before start time.</p>
                            </div>
                        </div>
                    @elseif($isCompleted)
                        @if($attendance)
                            <div class="alert alert-{{ $attendance->status === 'present' ? 'success' : ($attendance->status === 'late' ? 'warning' : 'danger') }} d-flex align-items-center">
                                <i class="bi bi-{{ $attendance->status === 'present' ? 'check-circle-fill' : ($attendance->status === 'late' ? 'clock-fill' : 'x-circle-fill') }} me-3 fs-4"></i>
                                <div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        @if($class->meeting_id)
                                            <div class="col-md-6">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-secondary" onclick="copyToClipboard('{{ $class->meeting_id }}')">
                                        ...
                                        @if($class->meeting_password)
                                            <div class="col-md-6">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-secondary" onclick="copyToClipboard('{{ $class->meeting_password }}')">
                                                        <i class="bi bi-clipboard"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <input type="text" class="form-control" value="{{ $class->meeting_url }}" readonly>
                                                <button class="btn btn-outline-secondary" onclick="copyToClipboard('{{ $class->meeting_url }}')">
                                                    <i class="bi bi-clipboard"></i>
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <a href="{{ $class->recording_url }}" target="_blank" class="btn btn-success">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3 pb-3 border-bottom">
                        ...
                        <strong>{{ $class->start_time->format('l, M d, Y') }}</strong>
                    </div>
                    <div class="mb-3 pb-3 border-bottom">
                        <small class="text-muted d-block mb-1">Start Time</small>
                        <strong>{{ $class->start_time->format('h:i A') }}</strong>
                    </div>
                    <div class="mb-3 pb-3 border-bottom">
                        <small class="text-muted d-block mb-1">End Time</small>
                        <strong>{{ $class->end_time->format('h:i A') }}</strong>
                    </div>
                    @if($class->duration)
                        <div class="mb-3 pb-3 border-bottom">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-3">
                                <span class="badge bg-{{ $attendance->status === 'present' ? 'success' : ($attendance->status === 'late' ? 'warning' : 'danger') }} px-4 py-3 fs-6">

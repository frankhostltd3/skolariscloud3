                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="mb-0">{{ $stats['submitted_assignments'] }}/{{ $stats['total_assignments'] }}
                                </h3>
                                ...
                                @foreach ($upcomingClasses as $class)
                                    <div class="list-group-item px-0">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="text-end">
                                                <span
                                                    class="badge bg-{{ $class->status === 'ongoing' ? 'success' : 'primary' }} mb-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center gap-2 mb-1">
                                                    <i
                                                        class="bi bi-{{ $material->type === 'document' ? 'file-earmark-pdf' : ($material->type === 'video' ? 'play-circle' : ($material->type === 'youtube' ? 'youtube' : ($material->type === 'link' ? 'link-45deg' : 'file-earmark'))) }} text-primary"></i>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('tenant.student.classroom.virtual.today') }}"
                                class="btn btn-outline-primary">
                                <i class="bi bi-calendar-day me-2"></i>Today's Classes
                            </a>
                            <a href="{{ route('tenant.student.classroom.materials.recent') }}"
                                class="btn btn-outline-success">
                                <i class="bi bi-clock-history me-2"></i>Recent Materials
                            </a>
                            <a href="{{ route('tenant.student.classroom.exercises.grades') }}"
                                class="btn btn-outline-info">
                                <i class="bi bi-trophy me-2"></i>My Grades
                            </a>
                            <a href="{{ route('tenant.student.classroom.virtual.attendance') }}"
                        ...
                        @if ($enrolledClasses->count() > 0)
                            <div class="list-group list-group-flush">
                                @foreach ($enrolledClasses as $enrollment)
                                    <a href="{{ route('tenant.student.classroom.classes.show', $enrollment->class_id) }}"
                                        class="list-group-item list-group-item-action px-0">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="mb-0">{{ $enrollment->schoolClass->name }}</h6>
                                                <small
                                                    class="text-muted">{{ $enrollment->academicYear->name ?? 'Current Year' }}</small>
                                            </div>
                            ...
                            <div class="list-group list-group-flush">
                                @foreach ($submittedAssignments as $submission)
                                    <div class="list-group-item px-0 py-2">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <h6 class="mb-1 small">{{ Str::limit($submission->exercise->title, 30) }}
                                                </h6>
                                                <small class="text-muted">

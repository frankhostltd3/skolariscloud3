...
@section('content')
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <!-- Header -->
                        @php
                            $exerciseShareLink = route('tenant.student.classroom.exercises.show', $exercise);
                            $exerciseShareText = 'Check out this assignment: ' . $exercise->title;
                        @endphp
                        <div class="d-flex justify-content-between align-items-start mb-4 gap-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <a href="{{ route('tenant.student.classroom.exercises.print', $exercise) }}" target="_blank"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" target="_blank" rel="noopener"
                                                href="mailto:?subject={{ rawurlencode($exerciseShareText) }}&body={{ rawurlencode($exerciseShareText . ' ' . $exerciseShareLink) }}">
                                                <i class="bi bi-envelope me-2"></i>Email
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" target="_blank" rel="noopener"
                                                href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($exerciseShareLink) }}">
                                                <i class="bi bi-facebook me-2"></i>Facebook
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" target="_blank" rel="noopener"
                                                href="https://twitter.com/intent/tweet?url={{ urlencode($exerciseShareLink) }}&text={{ urlencode($exerciseShareText) }}">
                                                <i class="bi bi-twitter-x me-2"></i>X
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" target="_blank" rel="noopener"
                                                href="https://api.whatsapp.com/send?text={{ urlencode($exerciseShareText . ' ' . $exerciseShareLink) }}">
                            ...
                            @if ($submission->grade !== null)
                                <div class="alert alert-success d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-0">Your submission has been graded by {{ $exercise->teacher->name }}
                                        </p>
                                    </div>
                                    <div class="text-end">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">
                                                ...
                                                @if ($exercise->late_penalty_percent)
                                                    Late submissions accepted with {{ $exercise->late_penalty_percent }}%
                                                    penalty per day.
                                                @else
                                ...
                                @else
                                    <div class="alert alert-danger d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">This assignment is overdue and late submissions are not
                                                accepted.</p>
                                        </div>
                                    </div>
                                @endif
                            @elseif($daysUntilDue <= 2)
                                <div class="alert alert-warning d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">This assignment is due in {{ $daysUntilDue }}
                                            day{{ $daysUntilDue !== 1 ? 's' : '' }}.</p>
                                    </div>
                                </div>
                            @endif
                        @endif
                        ...
                        @if ($exercise->description)
                            <div class="mb-4">
                                ...
                                <div class="wysiwyg-output border p-3 rounded">
                        ...
                        <div class="mb-4">
                            ...
                            @else
                                <p class="text-muted mb-0">No specific instructions provided.</p>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h5 class="mb-0"><i class="bi bi-journal-text me-2"></i>Assignment Content & Questions
                                </h5>
                                <span class="badge bg-light text-dark">Read all sections</span>
                            </div>
                            @if ($exercise->content)
                                <div id="assignment-content-student" class="wysiwyg-output border p-3 rounded">
                                    {!! $exercise->content !!}
                                </div>
                            @else
                                <div class="alert alert-light border mb-0">
                                    <i class="bi bi-exclamation-circle me-2"></i>Your teacher has not added the detailed
                                    assignment content yet. Check back later or contact them if you need clarification.
                                </div>
                            @endif
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="bg-success bg-opacity-10 p-3 rounded text-center">
                                            ...
                                            <h3 class="mb-0 text-success">
                                                {{ $submission->score }}/{{ $exercise->max_score }}</h3>
                                    ...
                                    <div class="col-md-6">
                                        <div class="bg-primary bg-opacity-10 p-3 rounded text-center">
                                            ...
                                            <h5 class="mb-0 text-primary">{{ $submission->graded_at->format('M d, Y') }}
                                            </h5>
                                ...
                                <form action="{{ route('tenant.student.classroom.exercises.submit', $exercise) }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="submission_text" id="submission_text"
                                            class="form-control @error('submission_text') is-invalid @enderror" rows="8" required>{{ old('submission_text') }}</textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @enderror
                                        <small class="text-muted">
                                            Max file size: 50MB. Supported formats: PDF, DOC, DOCX, XLS, XLSX, PPT, PPTX,
                                            ZIP, Images
                                        </small>
                                    </div>
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Important:</strong> Once you submit, you cannot edit or resubmit this
                                        assignment.
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm mt-4">
                    <div class="card-header bg-white border-0">
                        <h6 class="mb-0"><i class="bi bi-list-ol me-2"></i>Outline</h6>
                    </div>
                    <div class="card-body">
                        <p class="small text-muted">Use the outline below to jump to each section.</p>
                        <ul class="list-unstyled small mb-0" id="assignment-outline-student"></ul>
                        <div class="text-muted small mb-0" id="assignment-outline-empty-student">
                            The outline is generated when your teacher adds headings inside the assignment content.
                        </div>
                    </div>
                </div>
            </div>
    ...
    @push('scripts')
        <script>
            ...
            if (!window.buildAssignmentOutline) {
                window.buildAssignmentOutline = function(contentId, listId, emptyId) {
                    ...
                    headings.forEach((heading, index) => {
                        const anchorId = heading.id || `assignment-heading-${index + 1}`;
                        heading.id = anchorId;

                        const listItem = document.createElement('li');
                        listItem.className = 'mb-2 assignment-outline';

                        const link = document.createElement('a');
                        link.href = `#${anchorId}`;
                        link.textContent = heading.textContent.trim() || `Section ${index + 1}`;
                        link.className =
                            `d-block small ${heading.tagName === 'H3' ? 'ps-3' : ''}${heading.tagName === 'H4' ? 'ps-4' : ''}`;
            ...
            document.addEventListener('DOMContentLoaded', function() {
                window.buildAssignmentOutline('assignment-content-student', 'assignment-outline-student',
                    'assignment-outline-empty-student');
            });
        </script>
    @endpush
    ...
    @push('styles')
        <style>
            ...
            .assignment-outline a {
                color: #0d6efd;
            }

            .assignment-outline a:hover {

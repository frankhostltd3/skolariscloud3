                    ...
                    @if ($hasFullPayment && $currentTerm)
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                data-bs-target="#shareReportModal">
                                <i class="bi bi-share me-2"></i>{{ __('Share Report') }}
                            </button>
                            <a href="{{ route('tenant.student.academic.report.download', ['term_id' => $currentTerm->id]) }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">
                                            {{ number_format($statistics['current_term']['average_percentage'], 1) }}%</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">{{ $statistics['current_term']['total_assessments'] }}
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h3 class="mb-0 fw-bold">
                                            {{ number_format($statistics['current_term']['highest_score'], 0) }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($gradesBySubject as $subjectId => $subjectGrades)
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                @if ($subject && $subject->code)
                                                                    <br><small
                                                                        class="text-muted">{{ $subject->code }}</small>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="progress" style="height: 25px;">
                                                            <div class="progress-bar bg-{{ $avgPercentage >= 70 ? 'success' : ($avgPercentage >= 50 ? 'warning' : 'danger') }}"
                                                                role="progressbar" style="width: {{ $avgPercentage }}%">
                                                    ...
                                                    <td class="text-center">
                                                        <span
                                                            class="badge bg-{{ $avgPercentage >= 70 ? 'success' : ($avgPercentage >= 50 ? 'warning' : 'danger') }} fs-6">
                                                            {{ $avgGradeLetter }}
                                                        </span>
                                                    </td>
                                                    <td class="text-end">
                                                                ...
                                                                <table class="table table-sm table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>{{ __('Assessment') }}</th>
                                                                            <th>{{ __('Date') }}</th>
                                                                            <th class="text-center">{{ __('Score') }}
                                                                            </th>
                                                                            <th class="text-center">{{ __('Grade') }}
                                                                            </th>
                                                                            <th>{{ __('Teacher') }}</th>
                                                                            <th>{{ __('Remarks') }}</th>
                                                                        </tr>
                                                                        ...
                                                                        @foreach ($subjectGrades as $grade)
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <br><small
                                                                                        class="text-muted">{{ $grade->assessment_type }}</small>
                                                                                </td>
                                                                                <td>{{ $grade->assessment_date ? $grade->assessment_date->format('M d, Y') : 'N/A' }}
                                                                                </td>
                                                                                <td class="text-center">
                                                                                ...
                                                                                <td class="text-center">
                                                                                    <span
                                                                                        class="badge bg-secondary">{{ $grade->grade_letter ?? 'N/A' }}</span>
                                                                                </td>
                                                                                <td>{{ $grade->teacher->name ?? 'N/A' }}
                                                                                </td>
                                                                                <td>{{ $grade->remarks ?? '-' }}</td>
                                                                            </tr>
                                                                        @endforeach
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <small
                                        class="text-muted">{{ __('Your grades will appear here once they are published by your teachers.') }}</small>
                                </div>
                            @endif
                        </div>
                    </div>
                                                    ...
                                                    @if ($hasGrades)
                                                        ...
                                                        @if ($hasFullPayment)
                                                            <a href="{{ route('tenant.student.academic.report.download', ['term_id' => $term->id]) }}"
                                                                ...
                                                                <i
                                                                    class="bi bi-download me-2"></i>{{ __('Download Report') }}
                                                            </a>
                                                        @else
                                                            <button class="btn btn-secondary btn-sm w-100" disabled>
                                                                <i
                                                                    class="bi bi-lock me-2"></i>{{ __('Payment Required') }}
                                                            </button>
                                                        @endif
                                                    @else
                                                        <p class="text-muted small mb-0">
                                                            {{ __('No grades available for this term.') }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <strong
                                            class="text-{{ $statistics['overall']['average_percentage'] >= 70 ? 'success' : ($statistics['overall']['average_percentage'] >= 50 ? 'warning' : 'danger') }}">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-success">
                            ...
                            <div class="card-body">
                                <ul class="small mb-0">
                                    <li class="mb-2">
                                        {{ __('Review your grades regularly and identify areas for improvement') }}</li>
                                    <li class="mb-2">{{ __('Download your reports to track your progress over time') }}
                                    </li>
                                    <li class="mb-2">{{ __('Share your reports with parents or guardians') }}</li>
                                    <li class="mb-2">
                                        {{ __('Consult with teachers about subjects where you need help') }}</li>
                    ...
                    <form id="shareReportForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <small
                                    class="text-muted">{{ __('Enter the email address where you want to send the report') }}</small>
                            </div>
                        </div>

                                ...
                                <div class="row g-2 small">
                                    ...
                                    @if($quiz->duration_minutes)
                                        <div class="col-6">
                                            ...
                                            <span class="ms-3">{{ $quiz->duration_minutes }} {{ __('mins') }}</span>
                                        </div>
                                    @endif
                                    <div class="col-6">
                                        <i class="bi bi-list-ol text-primary me-1"></i>
                                        <strong>{{ __('Questions:') }}</strong><br>
                                        <span class="ms-3">{{ $quiz->questions->count() }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 small">
                                @if($quiz->start_at)
                                    <div class="mb-1">
                                        ...
                                        <strong>{{ __('Opens:') }}</strong> {{ $quiz->start_at->format('M d, Y g:i A') }}
                                    </div>
                                @endif
                                @if($quiz->end_at)
                                    <div class="mb-1">
                                        <i class="bi bi-calendar-x text-danger me-1"></i>
                                        <strong>{{ __('Closes:') }}</strong> {{ $quiz->end_at->format('M d, Y g:i A') }}
                                    </div>
                                @endif
                            </div>
    ...
    @else
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted small">{{ __('Check back later or contact your teacher for more information.') }}</p>
            </div>
        </div>
    @endif

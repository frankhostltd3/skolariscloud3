                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="{{ route('tenant.student.fees.show', optional($payment->invoice)->id ? optional($payment->invoice)->id : 0) }}"
                                class="btn btn-outline-primary">
                                <i class="bi bi-eye me-2"></i>{{ __('View Fee Details') }}
                            </a>
                            @if ($payment->status === 'failed')
                                <form method="POST" action="{{ route('tenant.student.fees.pay', $payment->fee) }}"
                                    class="d-inline">
                                    @csrf

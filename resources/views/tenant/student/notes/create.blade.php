                    ...
                    <form action="{{ route('tenant.student.notes.personal.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      rows="15" 
                                      required
                                      placeholder="{{ __('Write your notes here...') }}">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-2">
                                <input type="radio" class="btn-check" name="color" id="color1" value="#0d6efd" {{ old('color', '#0d6efd') == '#0d6efd' ? 'checked' : '' }}>

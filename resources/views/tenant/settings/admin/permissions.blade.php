...
@section('content')
<style>
.role-badge { font-size: 0.85rem; padding: 0.35rem 0.75rem; }
.permission-card { transition: all 0.3s; }
.permission-card:hover { box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15) !important; }
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <p class="text-muted mb-0">{{ __('Manage user roles, permissions, and security settings across the system') }}</p>
    </div>
    <div class="btn-group">
                ...
                <form action="{{ route('tenant.settings.admin.permissions.update') }}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="default_student_role" class="form-select @error('default_student_role') is-invalid @enderror">
                                <option value="student" {{ ($settings['default_student_role'] ?? 'student') == 'student' ? 'selected' : '' }}>Student</option>
                                <option value="prefect" {{ ($settings['default_student_role'] ?? 'student') == 'prefect' ? 'selected' : '' }}>Prefect</option>
                                <option value="monitor" {{ ($settings['default_student_role'] ?? 'student') == 'monitor' ? 'selected' : '' }}>Class Monitor</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="default_teacher_role" class="form-select @error('default_teacher_role') is-invalid @enderror">
                                <option value="teacher" {{ ($settings['default_teacher_role'] ?? 'teacher') == 'teacher' ? 'selected' : '' }}>Teacher</option>
                                <option value="hod" {{ ($settings['default_teacher_role'] ?? 'teacher') == 'hod' ? 'selected' : '' }}>Head of Department</option>
                                <option value="deputy" {{ ($settings['default_teacher_role'] ?? 'teacher') == 'deputy' ? 'selected' : '' }}>Deputy Principal</option>
                            </select>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="allow_student_login" name="allow_student_login" value="1"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="allow_parent_login" name="allow_parent_login" value="1"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="allow_teacher_login" name="allow_teacher_login" value="1"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="require_email_verification" name="require_email_verification" value="1"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="allow_password_reset" name="allow_password_reset" value="1"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="enable_two_factor" name="enable_two_factor" value="1"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="allow_registration" name="allow_registration" value="1"
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="require_strong_password" name="require_strong_password" value="1"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="min_password_length" class="form-control @error('min_password_length') is-invalid @enderror"
                                value="{{ old('min_password_length', $settings['min_password_length'] ?? '10') }}" min="6" max="32">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="max_login_attempts" class="form-control @error('max_login_attempts') is-invalid @enderror"
                                value="{{ old('max_login_attempts', $settings['max_login_attempts'] ?? '5') }}" min="1" max="20">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="session_timeout" class="form-control @error('session_timeout') is-invalid @enderror"
                                value="{{ old('session_timeout', $settings['session_timeout'] ?? '60') }}" min="5" max="480">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="restrict_by_ip" name="restrict_by_ip" value="1"
                        ...
                        <div class="col-md-6 mb-3" id="ip_whitelist_section" style="display: {{ ($settings['restrict_by_ip'] ?? false) ? 'block' : 'none' }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="teacher_manage_students" name="teacher_manage_students" value="1"
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="teacher_manage_classes" name="teacher_manage_classes" value="1"
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="student_view_reports" name="student_view_reports" value="1"
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mt-3">No permissions defined yet. Run the permissions seeder to populate system permissions.</p>
            ...
            <div class="card-body">
                <div class="mb-3 pb-3 border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge {{ ($settings['allow_student_login'] ?? true) ? 'bg-success' : 'bg-danger' }}">
                ...
                <div class="mb-3 pb-3 border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge {{ ($settings['require_email_verification'] ?? false) ? 'bg-warning' : 'bg-secondary' }}">
                ...
                <div class="mb-3 pb-3 border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge {{ ($settings['enable_two_factor'] ?? false) ? 'bg-success' : 'bg-secondary' }}">
                ...
                <div class="mb-3 pb-3 border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge {{ ($settings['require_strong_password'] ?? true) ? 'bg-success' : 'bg-danger' }}">
                ...
                <div class="mb-3 pb-3 border-bottom">
                    ...
                    <div class="fw-bold">{{ ($settings['password_expiry_days'] ?? 90) > 0 ? $settings['password_expiry_days'] . ' days' : 'Never' }}</div>
                </div>
                <div class="mb-0">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <p class="small text-muted mb-0">Roles define what users can see and do. Assign users to roles, then assign permissions to roles.</p>
                </div>
                <div class="mb-3">
                    <h6 class="small fw-bold">Permissions</h6>
                    <p class="small text-muted mb-0">Granular controls for specific actions. Best practice: assign permissions to roles, not individual users.</p>
                </div>
                <div class="mb-3">
                    <h6 class="small fw-bold">Access Control</h6>
                    <p class="small text-muted mb-0">Configure login requirements, session timeouts, and IP restrictions for enhanced security.</p>
                </div>
                <div class="mb-0">
            ...
            <form action="{{ route('tenant.settings.admin.roles.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="display_name" class="form-control" placeholder="e.g., Librarian" required>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('tenant.settings.admin.permissions.sync-registry') }}" method="POST">
                ...
                <div class="modal-body">
                    <p class="mb-0">This will synchronize user roles with the latest registry data. Proceed with caution.</p>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Select Role to Sync</label>
                        <select name="sync_role" class="form-select @error('sync_role') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="notify_sync_complete" name="notify_sync_complete" value="1" checked>
        ...
        <div class="modal-content">
            <form action="{{ route('tenant.settings.admin.roles.bulkAssign') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="notify_bulk_assign_complete" name="notify_bulk_assign_complete" value="1" checked>

                    ...
                    <div class="row g-3">
                        <div class="col-md-5">
                            <input type="text" name="search" class="form-control"
                                placeholder="Search by title, author, ISBN..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <tbody>
                            @forelse($books as $book)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-secondary bg-opacity-10 text-secondary">{{ $book->category }}</span>
                                    </td>
                                    <td>
                                        @if ($book->isbn)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form id="delete-form-{{ $book->id }}"
                                            action="{{ route('tenant.modules.library.books.destroy', $book) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center py-5">
                                        ...
                                        @can('books.create')
                                            <a href="{{ route('tenant.modules.library.books.create') }}"

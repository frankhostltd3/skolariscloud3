            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('tenant.modules.library.transactions.index') }}"
                                    ...
                                    <tbody>
                                        @foreach ($overdueTransactions as $overdue)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="text-danger">{{ $overdue->due_date->format('M d, Y') }}</span>
                                                </td>
                                                <td><span class="badge bg-danger">{{ $overdue->days_overdue }} days</span>
                                                </td>
                                                <td>
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            @forelse($popularBooks as $book)
                                <a href="{{ route('tenant.modules.library.books.show', $book) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="progress" style="height: 8px;">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{ ($category->count / $totalBooks) * 100 }}%"></div>
                                </div>
                            </div>
                        @empty
                            <div class="text-center py-3 text-muted">

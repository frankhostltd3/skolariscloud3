...
<div class="container-fluid">
    ...
    <form action="{{ route('tenant.modules.teachers.store') }}" method="POST" enctype="multipart/form-data" id="teacherForm">
        @csrf
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('qualification') is-invalid @enderror" id="qualification" name="qualification">
                                    ...
                                    @foreach(['PhD', 'Masters', 'Bachelors', 'Diploma', 'Certificate'] as $qual)
                                        <option value="{{ $qual }}" {{ old('qualification') == $qual ? 'selected' : '' }}>{{ $qual }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                <label for="experience_years" class="form-label">{{ __('Experience (Years)') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('joining_date') is-invalid @enderror" 
                                       id="joining_date" name="joining_date" value="{{ old('joining_date', date('Y-m-d')) }}">

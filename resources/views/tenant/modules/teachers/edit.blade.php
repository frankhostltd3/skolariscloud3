            ...
            <div class="col-lg-10 col-md-9">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">{{ __('Update teacher information') }}</p>
                    </div>
                    <a href="{{ route('tenant.modules.teachers.show', $teacher) }}" class="btn btn-outline-secondary">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                name="last_name" value="{{ old('last_name', $teacher->last_name) }}"
                                                required>
                                            @error('last_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('blood_group') is-invalid @enderror"
                                                ...
                                                @foreach (['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'] as $type)
                                                    <option value="{{ $type }}"
                                                        {{ old('blood_group', $teacher->blood_group) == $type ? 'selected' : '' }}>
                                                        {{ $type }}</option>
                                                @endforeach
                                            </select>
                                            @error('blood_group')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <small
                                                class="text-muted">{{ __('Max 2MB. Leave empty to keep current.') }}</small>
                                            @error('profile_photo')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="city" value="{{ old('city', $teacher->city) }}">
                                            @error('city')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="state" value="{{ old('state', $teacher->state) }}">
                                            @error('state')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('country', $teacher->country ?? 'Kenya') }}">
                                            @error('country')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('employment_type') is-invalid @enderror"
                                                ...
                                                <option value="visiting"
                                                    {{ old('employment_type', $teacher->employment_type) == 'visiting' ? 'selected' : '' }}>
                                                    {{ __('Visiting') }}</option>
                                            </select>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="emergency_contact_relation"
                                                ...
                                                value="{{ old('emergency_contact_relation', $teacher->emergency_contact_relation) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="medical_conditions" name="medical_conditions" rows="2">{{ old('medical_conditions', $teacher->medical_conditions) }}</textarea>
                                        </div>

                                        <div class="col-12">
                                            <label for="notes" class="form-label">{{ __('Notes') }}</label>
                                            <textarea class="form-control" id="notes" name="notes" rows="2">{{ old('notes', $teacher->notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status">
                                            ...
                                            <option value="on_leave"
                                                {{ old('status', $teacher->status) == 'on_leave' ? 'selected' : '' }}>
                                                {{ __('On Leave') }}</option>
                                            <option value="resigned"
                                                {{ old('status', $teacher->status) == 'resigned' ? 'selected' : '' }}>
                                                {{ __('Resigned') }}</option>
                                            <option value="terminated"
                                                {{ old('status', $teacher->status) == 'terminated' ? 'selected' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">
                                            ...
                                            <span id="text">{{ __('Update Teacher') }}</span>
                                        </button>
                                    </div>
                                </div>
                            </div>

...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('tenant.modules.students.store') }}" method="POST" enctype="multipart/form-data"
            id="studentForm">
            @csrf
            <div class="row">
                <!-- Main Content -->
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Date of Birth') }} <span
                                            class="text-danger">*</span></label>
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-success text-white">
                            <h5 class="card-title mb-0"><i class="bi bi-book me-2"></i>{{ __('Academic Information') }}
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Admission Number') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Class') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Class Stream / Section') }}</label>
                                    <select name="class_stream_id" id="classStreamSelect"
                                        class="form-select @error('class_stream_id') is-invalid @enderror">
                                        <option value="">{{ __('Select Stream (optional)') }}</option>
                                    </select>
                                    <small class="text-muted" id="streamCapacityHint" style="display:none"></small>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="section" value="{{ old('section') }}"
                                        class="form-control @error('section') is-invalid @enderror" placeholder="A">
                                    @error('section')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Admission Date') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Academic Year') }} <span
                                            class="text-danger">*</span></label>
                                    <select name="academic_year_id"
                                        ...
                                        @foreach ($academicYears as $year)
                                            <option value="{{ $year->id }}"
                                                {{ old('academic_year_id', $defaultAcademicYearId) == $year->id ? 'selected' : '' }}>
                                                {{ $year->name }}
                                                {{ $year->is_current ? '(' . __('Current') . ')' : '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">{{ __('Default: Student@123') }}</small>
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-info text-white">
                            <h5 class="card-title mb-0"><i class="bi bi-house me-2"></i>{{ __('Contact Information') }}
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="card-title mb-0"><i
                                    class="bi bi-people me-2"></i>{{ __('Guardian Information') }}
                            </h5>
                        </div>
                        <div class="card-body">
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#father-tab"
                                        type="button">
                                        <i class="bi bi-person me-1"></i>{{ __('Father') }}
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#mother-tab"
                                        type="button">
                                        <i class="bi bi-person me-1"></i>{{ __('Mother') }}
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#guardian-tab"
                                        type="button">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-secondary text-white">
                            <h5 class="card-title mb-0"><i
                                    class="bi bi-heart-pulse me-2"></i>{{ __('Medical Information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="allergies" rows="2" class="form-control @error('allergies') is-invalid @enderror"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="medications" rows="2" class="form-control @error('medications') is-invalid @enderror"
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-dark text-white">
                            <h5 class="card-title mb-0"><i
                                    class="bi bi-building me-2"></i>{{ __('Previous School Information') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="transfer_reason" rows="2" class="form-control @error('transfer_reason') is-invalid @enderror"
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header" style="background-color: #6f42c1; color: white;">
                            <h5 class="card-title mb-0"><i
                                    class="bi bi-universal-access me-2"></i>{{ __('Special Needs & Support') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                ...
                                <div class="col-12" id="specialNeedsDescription"
                                    style="display: {{ old('has_special_needs') ? 'block' : 'none' }};">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-light">
                            <h5 class="card-title mb-0"><i class="bi bi-file-text me-2"></i>{{ __('Additional Notes') }}
                            </h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card shadow-sm mb-4 sticky-top" style="top: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('tenant.modules.students.index') }}"
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled mb-0 small">
                                ...
                                <li class="mb-2"><i
                                        class="bi bi-check-circle text-success me-2"></i>{{ __('Admission number must be unique') }}
                                </li>
                                <li class="mb-2"><i
                                        class="bi bi-check-circle text-success me-2"></i>{{ __('Profile photo max size: 2MB') }}
                                </li>
                                <li class="mb-2"><i
                                        class="bi bi-check-circle text-success me-2"></i>{{ __('Provide at least one guardian contact') }}
                                </li>
                                <li class="mb-2"><i
                                        class="bi bi-check-circle text-success me-2"></i>{{ __('Emergency contact is recommended') }}
                                </li>
                                <li class="mb-0"><i
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const streamSelect = document.getElementById('classStreamSelect');
            const streamCapacityHint = document.getElementById('streamCapacityHint');
            const initialStreamId = @json(old('class_stream_id'));

            function renderStreams(selectedClassId, selectedStreamId = null) {
                if (!streamSelect) {
                    return;
                }

                streamSelect.innerHTML = `<option value="">${@json(__('Select Stream (optional)'))}</option>`;
                streamSelect.disabled = true;
                if (streamCapacityHint) {
                    streamCapacityHint.style.display = 'none';
                }

                if (!selectedClassId || !streamsByClass[selectedClassId] || !streamsByClass[selectedClassId]
                    .length) {
                    return;
                }
                ...
                streamsByClass[selectedClassId].forEach(stream => {
                    const option = document.createElement('option');
                    option.value = stream.id;
                    option.textContent =
                        `${stream.name} (${stream.active_students_count}/${stream.capacity})`;
                    option.dataset.capacity = stream.capacity || 0;
                    option.dataset.enrolled = stream.active_students_count || 0;

                    if (selectedStreamId && Number(selectedStreamId) === Number(stream.id)) {
            ...
            function updateStreamHint() {
                if (!streamSelect || !streamSelect.value || !streamCapacityHint) {
                    if (streamCapacityHint) {
                        streamCapacityHint.style.display = 'none';
                    }
                    return;
                ...
                const enrolled = selectedOption?.dataset.enrolled ?? 0;
                streamCapacityHint.textContent = `${@json(__('Capacity'))}: ${enrolled}/${capacity}`;
                streamCapacityHint.style.display = 'block';
            }

            if (classSelect) {
                classSelect.addEventListener('change', () => {
                    renderStreams(classSelect.value);
                });

                renderStreams(classSelect.value, initialStreamId);
            }

            if (streamSelect) {
                streamSelect.addEventListener('change', updateStreamHint);
            }
        });
    </script>
@endpush

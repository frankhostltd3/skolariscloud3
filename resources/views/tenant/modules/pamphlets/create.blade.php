...
@section('content')
<div class="container">
    <h1 class="mb-3">Add Pamphlet</h1>
    <form method="POST" action="{{ route('tenant.modules.bookstore.pamphlets.store') }}">
        @csrf
        <div class="mb-3">
    ...
    <a href="{{ route('tenant.modules.bookstore.pamphlets.index') }}" class="btn btn-link">Cancel</a>
    </form>
</div>
@endsection

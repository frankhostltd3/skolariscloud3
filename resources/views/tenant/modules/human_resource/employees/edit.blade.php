    ...
    <div class="container">
            ...
            <div class="modal fade" id="createUserModal" tabindex="-1" aria-labelledby="createUserModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="POST"
                            action="{{ route('tenant.modules.human-resource.employees.create-user-account', $employee) }}">
                            @csrf
                            <div class="modal-body">
                                <div class="alert alert-info">
                                    <i class="bi bi-info-circle"></i>
                                    This will create a user account that allows <strong>{{ $employee->full_name }}</strong>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $employee->full_name }} ({{ $employee->employee_number }})" disabled>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="role" name="role" required>
                                        ...
                                        <option value="Teacher" {{ $employee->is_teacher ? 'selected' : '' }}>Teacher
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">User will be required to change this password after
                                        first login (expires in 7 days).</small>
                                </div>
        ...
        <ul class="nav nav-tabs mb-4" id="employeeTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="employee-info-tab" data-bs-toggle="tab" data-bs-target="#employee-info"
        ...
        <div class="tab-content" id="employeeTabsContent">
            ...
            <div class="tab-pane fade show active" id="employee-info" role="tabpanel">
                <form method="POST" action="{{ route('tenant.modules.human-resource.employees.update', $employee) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            @if ($employee->photo_path)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $employee->photo_path) }}" alt="Current Photo"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $employee->employee_number ?? 'Will be auto-generated' }}" disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="employee_type" name="employee_type" required>
                                ...
                                <option value="full_time"
                                    {{ old('employee_type', $employee->employee_type) === 'full_time' ? 'selected' : '' }}>
                                    Full Time</option>
                                <option value="part_time"
                                    {{ old('employee_type', $employee->employee_type) === 'part_time' ? 'selected' : '' }}>
                                    Part Time</option>
                                <option value="intern"
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="employment_status" name="employment_status">
                                ...
                                <option value="on_leave"
                                    {{ old('employment_status', $employee->employment_status) === 'on_leave' ? 'selected' : '' }}>
                                    On Leave</option>
                                <option value="inactive"
                                    {{ old('employment_status', $employee->employment_status) === 'inactive' ? 'selected' : '' }}>
                                    Inactive</option>
                                <option value="suspended"
                                    {{ old('employment_status', $employee->employment_status) === 'suspended' ? 'selected' : '' }}>
                                    Suspended</option>
                            ...
                            <div class="card">
                                <div class="card-header bg-warning text-dark">
                                    <h5 class="card-title mb-0">
                                        <i class="bi bi-shield-lock"></i> Password Management for
                                        {{ $employee->full_name }}
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-info">
                                        ...
                                        @if ($employee->user->password_changed_at)
                                            ...
                                            {{ $employee->user->password_changed_at->diffForHumans() }}
                                        @endif
                                    </div>
                                    ...
                                    <form method="POST"
                                        action="{{ route('admin.users.password.reset', $employee->user) }}">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            <label for="new_password_confirmation" class="form-label">Confirm New Password
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="form-text text-muted">This will be logged in the security audit
                                                trail.</small>
                                            @error('reason')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3 form-check">
                                            <input type="checkbox" class="form-check-input" id="notify_user"
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('admin.users.password.show', $employee->user) }}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info small mt-3">
                                        ...
                                        <strong>Tip:</strong> You can also manage this user's password from the main
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (resetPasswordBtn) {
                resetPasswordBtn.closest('form').addEventListener('submit', function(e) {
                    ...
                    if (!confirm(
                            'Are you sure you want to reset this user\'s password? This action will be logged.'
                            )) {
                        e.preventDefault();
                        return false;
                    }

...
<div class="container">
  <div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <div class="d-flex gap-2">
      <a href="{{ route('tenant.modules.human_resources.payroll-settings.edit') }}" class="btn btn-primary btn-sm">
        <i class="bi bi-pencil"></i> {{ __('Edit Settings') }}
      </a>
      <form method="POST" action="{{ route('tenant.modules.human_resources.payroll-settings.export') }}" style="display: inline;">
        @csrf
      ...
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-body">
          <div class="mb-2">
            ...
            <div class="fw-semibold">{{ $groupedSettings['pay_period']['pay_frequency']['options'][$currentSettings['pay_frequency'] ?? ''] ?? __('Not Set') }}</div>
          </div>
          <div class="mb-2">
      ...
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-body">
          <div class="mb-2">
            ...
            <div class="fw-semibold">{{ $groupedSettings['currency']['default_currency']['options'][$currentSettings['default_currency'] ?? ''] ?? __('Not Set') }}</div>
          </div>
          <div class="mb-2">
      ...
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-body">
          ...
          <div class="mb-0">
            ...
            <div class="fw-semibold">{{ $groupedSettings['banking']['payment_method']['options'][$currentSettings['payment_method'] ?? ''] ?? __('Not Set') }}</div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          <div class="mb-2">
            ...
            <div class="fw-semibold">
              <span class="badge {{ ($currentSettings['auto_process_payroll'] ?? false) ? 'bg-success' : 'bg-secondary' }}">
          ...
          <div class="mb-2">
            ...
            <div class="fw-semibold">
              <span class="badge {{ ($currentSettings['email_pay_slips'] ?? false) ? 'bg-success' : 'bg-secondary' }}">
          ...
          <div class="mb-0">
            ...
            <div class="fw-semibold">
              <span class="badge {{ ($currentSettings['export_to_accounting'] ?? false) ? 'bg-success' : 'bg-secondary' }}">
  ...
  <div class="card mt-4 shadow-sm">
    ...
    <div class="card-body">
      <div class="row g-3">
        <div class="col-md-4">
          <a href="{{ route('tenant.modules.human_resources.payroll-settings.edit') }}" class="btn btn-outline-primary w-100">
        ...
        <div class="col-md-4">
          <form method="POST" action="{{ route('tenant.modules.human_resources.payroll-settings.reset') }}" style="display: inline;">
            @csrf
            @method('POST')
            <button type="submit" class="btn btn-outline-warning w-100" onclick="return confirm('{{ __('Are you sure you want to reset all settings to defaults?') }}')">
  ...
  <div class="card mt-4 shadow-sm">
    ...
    <div class="card-body">
      <div class="row text-center">
        ...
        <div class="col-md-3">
          <div class="h4 text-warning mb-1">{{ $settings->where('category', 'salary_components')->count() }}</div>

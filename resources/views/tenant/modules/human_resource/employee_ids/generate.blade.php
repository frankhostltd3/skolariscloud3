            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('tenant.modules.human-resource.employee-ids.download-svg', ['employee_id' => $employee->id, 'template_id' => $template->id]) }}"
                                class="btn btn-success btn-sm me-2" target="_blank">
                                <i class="fas fa-download"></i> {{ __('Download SVG') }}
                            </a>
                            <a href="{{ route('tenant.modules.human-resource.employee-ids.download-png', ['employee_id' => $employee->id, 'template_id' => $template->id]) }}"
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body text-start">
                                        <p><small
                                                class="text-muted">{{ __('The QR code contains the following information:') }}</small>
                                        </p>
                        ...
                        <div class="mt-4">
                            <a href="{{ route('tenant.modules.human-resource.employee-ids.index') }}"

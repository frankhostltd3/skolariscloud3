            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    @if($profile)
                                ...
                                <div class="row g-3">
                                    ...
                                    @if($profile->alternate_phone)
                                        <div class="col-md-6">
                                            ...
                                            <p><a href="tel:{{ $profile->alternate_phone }}">{{ $profile->alternate_phone }}</a></p>
                                        </div>
                                    @endif
                                    @if($profile->address)
                                        <div class="col-12">
                        ...
                        @if($profile->occupation || $profile->employer || $profile->work_phone || $profile->work_address || $profile->annual_income)
                            <div class="card shadow-sm mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="border rounded p-3">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <h6 class="mb-0">
                                                            <a href="{{ route('tenant.modules.students.show', $student) }}" class="text-decoration-none">
                                                                {{ $student->full_name }}
                                                            </a>
                                                        </h6>
                                                        <span class="badge bg-primary">{{ ucfirst($student->pivot->relationship) }}</span>
                                                    </div>
                                                    <p class="text-muted mb-2 small">
                                                        <i class="bi bi-hash me-1"></i>{{ $student->admission_no }}
                                                        @if($student->class)
                                                            <span class="ms-2"><i class="bi bi-book me-1"></i>{{ $student->class->name }}</span>
                                                        @endif
                                                    </p>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        @if($profile->emergency_contact_phone)
                                            <div class="col-md-4">
                                                <label class="form-label text-muted">{{ __('Phone') }}</label>
                                                <p><a href="tel:{{ $profile->emergency_contact_phone }}">{{ $profile->emergency_contact_phone }}</a></p>
                                            </div>
                                        @endif
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                @if($user->is_active)
                                    <button type="button" class="btn btn-outline-warning" onclick="deactivateUser({{ $user->id }})">

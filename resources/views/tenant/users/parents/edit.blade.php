        ...
        <div class="col-lg-10 col-md-9">
            ...
            @if ($errors->any())
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h6 class="alert-heading"><i class="bi bi-exclamation-triangle me-2"></i>{{ __('Please correct the following errors:') }}</h6>
                    <ul class="mb-0">
            ...
            <form action="{{ route('tenant.users.parents.update', $user) }}" method="POST" enctype="multipart/form-data" id="parentForm">
                @csrf
                @method('PUT')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('national_id') is-invalid @enderror" 
                                               id="national_id" name="national_id" value="{{ old('national_id', $profile->national_id ?? '') }}" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('blood_group') is-invalid @enderror" id="blood_group" name="blood_group">
                                            ...
                                            @foreach(['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'] as $type)
                                                <option value="{{ $type }}" {{ old('blood_group', $profile->blood_group ?? '') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-muted">{{ __('Max 2MB. Leave empty to keep current photo.') }}</small>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" class="form-control @error('alternate_phone') is-invalid @enderror" 
                                               id="alternate_phone" name="alternate_phone" value="{{ old('alternate_phone', $profile->alternate_phone ?? '') }}" 
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" 
                                                  id="address" name="address" rows="2" placeholder="123 Main Street">{{ old('address', $profile->address ?? '') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('city') is-invalid @enderror" 
                                               id="city" name="city" value="{{ old('city', $profile->city ?? '') }}" placeholder="Nairobi">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('state') is-invalid @enderror" 
                                               id="state" name="state" value="{{ old('state', $profile->state ?? '') }}" placeholder="Nairobi">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('postal_code') is-invalid @enderror" 
                                               id="postal_code" name="postal_code" value="{{ old('postal_code', $profile->postal_code ?? '') }}" placeholder="00100">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('country') is-invalid @enderror" 
                                               id="country" name="country" value="{{ old('country', $profile->country ?? 'Kenya') }}">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('occupation') is-invalid @enderror" 
                                               id="occupation" name="occupation" value="{{ old('occupation', $profile->occupation ?? '') }}" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('employer') is-invalid @enderror" 
                                               id="employer" name="employer" value="{{ old('employer', $profile->employer ?? '') }}" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" class="form-control @error('work_phone') is-invalid @enderror" 
                                               id="work_phone" name="work_phone" value="{{ old('work_phone', $profile->work_phone ?? '') }}" 
                                               placeholder="+254 20 000000">
                                        @error('work_phone')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6">
                                        <label for="annual_income" class="form-label">{{ __('Annual Income (Optional)') }}</label>
                                        <input type="number" class="form-control @error('annual_income') is-invalid @enderror" 
                                               id="annual_income" name="annual_income" value="{{ old('annual_income', $profile->annual_income ?? '') }}" 
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('work_address') is-invalid @enderror" 
                                                  id="work_address" name="work_address" rows="2">{{ old('work_address', $profile->work_address ?? '') }}</textarea>
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div id="children-container">
                                    @php
                                        $existingStudents = old('students', $profile?->students->pluck('id')->toArray() ?? []);
                                        $existingRelationships = old('relationships', $profile?->students->pluck('pivot.relationship')->toArray() ?? []);
                                    @endphp
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-select" name="relationships[]">
                                                            <option value="father" {{ ($existingRelationships[$index] ?? '') == 'father' ? 'selected' : '' }}>{{ __('Father') }}</option>
                                                            <option value="mother" {{ ($existingRelationships[$index] ?? '') == 'mother' ? 'selected' : '' }}>{{ __('Mother') }}</option>
                                                            <option value="guardian" {{ ($existingRelationships[$index] ?? 'guardian') == 'guardian' ? 'selected' : '' }}>{{ __('Guardian') }}</option>
                                                            <option value="relative" {{ ($existingRelationships[$index] ?? '') == 'relative' ? 'selected' : '' }}>{{ __('Relative') }}</option>
                                                            <option value="other" {{ ($existingRelationships[$index] ?? '') == 'other' ? 'selected' : '' }}>{{ __('Other') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                @if($index > 0)
                                                    <button type="button" class="btn btn-sm btn-outline-danger mt-2 remove-child">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" 
                                                  id="medical_conditions" name="medical_conditions" rows="2">{{ old('medical_conditions', $profile->medical_conditions ?? '') }}</textarea>
                                    </div>

                                    <div class="col-12">
                                        <label for="notes" class="form-label">{{ __('Notes') }}</label>
                                        <textarea class="form-control" 
                                                  id="notes" name="notes" rows="2">{{ old('notes', $profile->notes ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <option value="active" {{ old('status', $profile->status ?? 'active') == 'active' ? 'selected' : '' }}>{{ __('Active') }}</option>
                                        <option value="inactive" {{ old('status', $profile->status ?? '') == 'inactive' ? 'selected' : '' }}>{{ __('Inactive') }}</option>
                                        <option value="deceased" {{ old('status', $profile->status ?? '') == 'deceased' ? 'selected' : '' }}>{{ __('Deceased') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>

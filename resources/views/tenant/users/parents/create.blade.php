...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-10 col-md-9">
            ...
            <form action="{{ route('tenant.users.parents.store') }}" method="POST" enctype="multipart/form-data" id="parentForm">
                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" 
                                                  id="address" name="address" rows="2" placeholder="123 Main Street">{{ old('address') }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('city') is-invalid @enderror" 
                                               id="city" name="city" value="{{ old('city') }}" placeholder="Nairobi">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('state') is-invalid @enderror" 
                                               id="state" name="state" value="{{ old('state') }}" placeholder="Nairobi">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('postal_code') is-invalid @enderror" 
                                               id="postal_code" name="postal_code" value="{{ old('postal_code') }}" placeholder="00100">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('work_address') is-invalid @enderror" 
                                                  id="work_address" name="work_address" rows="2">{{ old('work_address') }}</textarea>

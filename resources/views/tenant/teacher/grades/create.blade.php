                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="assessment_name" name="assessment_name"
                                           value="{{ old('assessment_name') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="assessment_type" name="assessment_type" required>
                                        ...
                                        <option value="participation" {{ old('assessment_type') == 'participation' ? 'selected' : '' }}>Participation</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="assessment_date"
                                           name="assessment_date" value="{{ old('assessment_date', date('Y-m-d')) }}" required>

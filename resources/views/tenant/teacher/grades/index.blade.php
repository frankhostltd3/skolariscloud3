...
@section('content')
    <div class="container-fluid">
        ...
        @if (!empty($gradesTableMissing) && $gradesTableMissing)
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <i class="bi bi-exclamation-triangle me-2"></i>The grades feature is not available for this school yet.
                Please contact an administrator to enable grading.
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            </div>
        @endif
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="assessment_type" id="assessment_type" class="form-select">
                                ...
                                <option value="assignment" {{ $assessmentType == 'assignment' ? 'selected' : '' }}>
                                    Assignment</option>
                                <option value="project" {{ $assessmentType == 'project' ? 'selected' : '' }}>Project
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="q" id="q" class="form-control"
                                placeholder="Name or email" value="{{ $studentQ }}">
                        </div>
                        <div class="col-md-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @endif
                                                        <div>
                                                            <div class="fw-medium">{{ $grade->student->name ?? 'N/A' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge bg-info">{{ ucfirst($grade->assessment_type) }}</span>
                                                </td>
                                                <td>
                                                    @php
                                                        $percentage =

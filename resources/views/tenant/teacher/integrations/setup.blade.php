...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                @php
                    $isManaged = $integration?->managedByAdmin();
                @endphp
                <!-- Header -->
                ...
                @if (!empty($tableMissing))
                    <div class="alert alert-warning" role="alert">
                        ...
                        Integration settings are not available for this school yet. Please ask your administrator to run the
                        latest tenant migrations before configuring {{ ucfirst(str_replace('_', ' ', $platform)) }}.
                    </div>
                @else
                    <!-- Setup Form -->
                    <div class="card">
                        <div class="card-body">
                            @if ($isManaged)
                                <div class="alert alert-primary" role="alert">
                                    ...
                                    This integration is centrally managed by your administrator. Values are read-only for
                                    teachers.
                                </div>
                            @endif
                            <form action="{{ route('tenant.teacher.classroom.integrations.store', $platform) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="mb-4">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label" for="is_enabled">
                                            <strong>Enable {{ ucfirst(str_replace('_', ' ', $platform)) }}
                                                Integration</strong>
                                        </label>
                                    </div>
                                    <small class="text-muted">When enabled, the system will automatically create meetings
                                        using this platform's API</small>
                                </div>
                                ...
                                @if ($platform === 'zoom')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <small class="text-muted">Found in Zoom Marketplace under your Server-to-Server
                                            OAuth app</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password"
                                            class="form-control @error('api_secret') is-invalid @enderror" id="api_secret"
                                            name="api_secret"
                                        ...
                                        @error('api_secret')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">Keep this secret secure - it will be encrypted in our
                                            database</small>
                                    </div>

                                    <!-- Help Text -->
                                    <div class="alert alert-info">
                                        <h6 class="alert-heading"><i class="bi bi-info-circle me-2"></i>How to get Zoom
                                            credentials:</h6>
                                        <ol class="mb-0 small">
                                            <li>Visit <a href="https://marketplace.zoom.us/" target="_blank"
                                                    class="alert-link">Zoom Marketplace</a></li>
                                ...
                                @elseif($platform === 'google_meet')
                                    ...
                                    <div class="alert alert-success">
                                        <h6 class="alert-heading"><i class="bi bi-info-circle me-2"></i>How to get Google
                                            Meet credentials:</h6>
                                        <ol class="mb-0 small">
                                            <li>Visit <a href="https://console.cloud.google.com/" target="_blank"
                                            ...
                                            <li>Add authorized redirect URI: <code>{{ route('tenant.dashboard') }}</code>
                                            </li>
                                ...
                                @elseif($platform === 'microsoft_teams')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('client_id') is-invalid @enderror" id="client_id"
                                            name="client_id"
                                            value="{{ old('client_id', $integration->decrypted_client_id ?? '') }}"
                                    ...
                                    <div class="alert alert-primary">
                                        <h6 class="alert-heading"><i class="bi bi-info-circle me-2"></i>How to get
                                            Microsoft Teams credentials:</h6>
                                        <ol class="mb-0 small">
                                            <li>Visit <a href="https://portal.azure.com/" target="_blank"
                                                    class="alert-link">Azure Portal</a></li>
                                            <li>Go to "Azure Active Directory" → "App registrations" → "New registration"
                                            </li>
                                ...
                                <div class="d-flex gap-2 justify-content-end">
                                    <a href="{{ route('tenant.teacher.classroom.integrations.index') }}"
                                        class="btn btn-secondary">
                                        Cancel
                                    </a>
                                    <button type="submit" class="btn btn-primary" {{ $isManaged ? 'disabled' : '' }}>
                    ...
                    <div class="card mt-3 border-warning">
                        <div class="card-body">
                            ...
                            <p class="small text-muted mb-0">
                                All API credentials are encrypted using AES-256 encryption before being stored in the
                                database.
                                Never share your credentials with anyone. If you believe your credentials have been
                                compromised,

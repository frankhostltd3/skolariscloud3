                        ...
                        <div class="col-md-8">
                            ...
                            <div class="progress" style="height: 30px;">
                                @php
                                    ...
                                    $colorClass =
                                        $percentage >= 90 ? 'success' : ($percentage >= 75 ? 'warning' : 'danger');
                                @endphp
                            ...
                            <tbody>
                                @foreach ($patterns['student_stats'] as $stat)
                                    @php
                                        ...
                                        $statusColor = $statusColors[$stat['status_label']] ?? 'secondary';
                                    @endphp
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                @if ($stat['student'] && $stat['student']->photo)
                                                    <img src="{{ asset('storage/' . $stat['student']->photo) }}"
                                                        alt="{{ $stat['student']->name }}" class="rounded-circle me-2"
                                                        width="32" height="32">
                                                @else
                                        ...
                                        <td class="text-center"><span
                                                class="badge bg-success">{{ $stat['present'] }}</span></td>
                                        <td class="text-center"><span
                                                class="badge bg-danger">{{ $stat['absent'] }}</span></td>
                                        <td class="text-center"><span class="badge bg-warning">{{ $stat['late'] }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge bg-{{ $statusColor }}">{{ ucfirst($stat['status_label']) }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

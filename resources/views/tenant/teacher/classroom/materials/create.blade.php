    ...
    <div class="container-fluid">
        ...
        @if ($classes->isEmpty() || $subjects->isEmpty())
            <div class="alert alert-info" role="alert">
                ...
                Classes or subjects are not available yet. You can review the form layout, but uploads will remain disabled
                until both resources exist.
            </div>
        @endif
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('tenant.teacher.classroom.materials.store') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="3" placeholder="Brief description of this material...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="type" class="form-label">Material Type <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('tenant.teacher.classroom.materials.index') }}"
                                    class="btn btn-outline-secondary">
                                    Cancel
                                </a>
                                <button type="submit" class="btn btn-primary" id="submitBtn"
                                    {{ $classes->isEmpty() || $subjects->isEmpty() ? 'disabled' : '' }}>
                ...
                <div class="card border-0 shadow-sm bg-light mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="small mb-0 text-muted">PDF, Word (.doc, .docx), Excel (.xls, .xlsx), PowerPoint
                                (.ppt, .pptx)</p>
                        </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                fileInput.addEventListener('change', function() {
                    if (this.files.length > 0) {
                        ...
                        if (fileSizeMB > 50) {
                            alert(
                                'File size exceeds 50MB limit. Please choose a smaller file or use a link instead.');
                            this.value = '';

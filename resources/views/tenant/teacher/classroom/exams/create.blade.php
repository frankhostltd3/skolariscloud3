                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('instructions') is-invalid @enderror" id="instructions" name="instructions"
                                    rows="4" placeholder="Exam rules and instructions">{{ old('instructions') }}</textarea>
                                @error('instructions')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('creation_method') is-invalid @enderror"
                                        ...
                                        <option value="manual"
                                            {{ old('creation_method', 'manual') === 'manual' ? 'selected' : '' }}>Manual
                                            authoring</option>
                                        <option value="automatic"
                                            {{ old('creation_method') === 'automatic' ? 'selected' : '' }}>Automatic
                                            template</option>
                                        <option value="ai" {{ old('creation_method') === 'ai' ? 'selected' : '' }}>AI
                                            assisted</option>
                                    </select>
                                    <small class="text-muted">Automatic and AI paths queue generation jobs using the
                                        syllabus segments you provide.</small>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('activation_mode') is-invalid @enderror"
                                        ...
                                        <option value="schedule"
                                            {{ old('activation_mode', 'schedule') === 'schedule' ? 'selected' : '' }}>
                                            Scheduled window</option>
                                        <option value="manual" {{ old('activation_mode') === 'manual' ? 'selected' : '' }}>
                                            Manual activation</option>
                                        <option value="auto" {{ old('activation_mode') === 'auto' ? 'selected' : '' }}>
                                            Auto start with class</option>
                                    </select>
                                    <small class="text-muted">Scheduled mode auto-activates once approved. Manual keeps
                                        exams hidden until you start them.</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('grading_method') is-invalid @enderror"
                                        ...
                                        <option value="auto"
                                            {{ old('grading_method', 'auto') == 'auto' ? 'selected' : '' }}>
                                            Auto Grading
                                        </option>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="allow_backtrack"
                                            ...
                                            {{ old('allow_backtrack', true) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="disable_copy_paste"
                                            ...
                                            {{ old('disable_copy_paste', true) ? 'checked' : '' }}>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('max_tab_switches', 5) }}" min="0" max="20">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('auto_submit_on') is-invalid @enderror"
                                        ...
                                        <option value="time_up"
                                            {{ old('auto_submit_on') == 'time_up' ? 'selected' : '' }}>
                                            When Time is Up
                                        </option>
                                        ...
                                        <option value="both"
                                            {{ old('auto_submit_on', 'both') == 'both' ? 'selected' : '' }}>
                                            Both
                                        </option>
                                    </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info mb-0">
                                <small>
                                    ...
                                    <strong>Draft</strong>: Keep private while editing<br>
                                    <strong>Ready</strong>: Submit for review and unlock automatically once approved
                                </small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <button type="submit" name="action" value="submit_for_review"
    ...
    <script>
        ...
        document.querySelectorAll('button[name="action"]').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                } else if (this.value === 'submit_for_review') {

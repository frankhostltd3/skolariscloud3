                ...
                <div class="card-body">
                    <form action="{{ route('tenant.teacher.classroom.virtual.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Brief description of what will be covered">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div id="recurring_options" style="display: none;" class="ms-4 mb-3">
                            ...
                            <input type="date" class="form-control" name="recurrence_end_date" placeholder="End Date">
                        </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('tenant.teacher.classroom.integrations.setup', 'zoom') }}" class="btn btn-sm btn-outline-info">
                            <i class="bi bi-camera-video me-2"></i>Setup Zoom
                        </a>
                        <a href="{{ route('tenant.teacher.classroom.integrations.setup', 'google_meet') }}" class="btn btn-sm btn-outline-success">
                            <i class="bi bi-google me-2"></i>Setup Google Meet
                        </a>
                        <a href="{{ route('tenant.teacher.classroom.integrations.setup', 'microsoft_teams') }}" class="btn btn-sm btn-outline-primary">

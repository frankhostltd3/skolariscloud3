...
<div class="container-fluid">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="upcoming" role="tabpanel">
            <div class="row g-4">
                @php
                    $upcomingClasses = $virtualClasses->where('status', 'scheduled')->where('scheduled_at', '>', now());
                @endphp
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-primary">
                        <div class="card-header bg-primary text-white">
                            ...
                            <small>{{ $class->class->name ?? 'N/A' }} • {{ $class->subject->name ?? 'N/A' }}</small>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('tenant.teacher.classroom.virtual.show', $class) }}" class="btn btn-outline-primary btn-sm">
                                    <i class="bi bi-box-arrow-up-right me-2"></i>View Details
                                </a>
                                <a href="{{ route('tenant.teacher.classroom.virtual.edit', $class) }}" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="card-footer bg-light">
                            <small class="text-muted">
                                <i class="bi bi-clock me-1"></i>Starts {{ $class->scheduled_at->diffForHumans() }}
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-danger">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-2">
                                <i class="bi bi-clock me-2"></i>
                                <strong>Started:</strong> {{ $class->starts_at ? $class->starts_at->diffForHumans() : 'Just now' }}
                            </p>
                            <p class="text-muted mb-2">
                                <i class="bi bi-hourglass-split me-2"></i>
                                <strong>Duration:</strong> {{ $class->duration_minutes }} minutes
                            ...
                            <p class="text-muted mb-3">
                                ...
                                <a href="{{ $class->meeting_url }}" target="_blank" class="text-decoration-none">Join Meeting</a>
                            </p>
                            @endif
                            <hr>
                            <div class="d-grid gap-2">
                                ...
                                <form action="{{ route('tenant.teacher.classroom.virtual.end', $class) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-danger btn-sm w-100" onclick="return confirm('Are you sure you want to end this class?')">
                    ...
                    <div class="card h-100 border-success">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-3">
                                ...
                                <a href="{{ $class->recording_url }}" target="_blank" class="text-decoration-none">View Recording</a>
                            </p>
                            @endif
                            <hr>
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('tenant.teacher.classroom.virtual.attendance', $class) }}" class="btn btn-outline-info btn-sm">
                        ...
                        <div class="card-footer bg-light">
                            <small class="text-muted">
                                <i class="bi bi-clock me-1"></i>Ended {{ $class->ends_at ? $class->ends_at->diffForHumans() : 'recently' }}
                            </small>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('tenant.teacher.classroom.virtual.show', $class) }}" class="btn btn-outline-primary" title="View Details">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="{{ route('tenant.teacher.classroom.virtual.edit', $class) }}" class="btn btn-outline-secondary" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form action="{{ route('tenant.teacher.classroom.virtual.destroy', $class) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this virtual class?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">
                                        No virtual classes scheduled yet. <a href="{{ route('tenant.teacher.classroom.virtual.create') }}">Schedule one now</a>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>

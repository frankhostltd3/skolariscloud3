...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item"><a href="{{ route('tenant.teacher.classroom.virtual.show', $class) }}">{{ $class->title }}</a></li>
    ...
    @if($class->status !== 'scheduled')
        <div class="alert alert-warning">
            ...
            <strong>Note:</strong> This class is {{ $class->status }}. You can only edit scheduled classes before they start.
        </div>
    @endif
                    ...
                    <form action="{{ route('tenant.teacher.classroom.virtual.update', $class) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Brief description of what will be covered in this class">{{ old('description', $class->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="platform" class="form-label">Meeting Platform <span class="text-danger">*</span></label>
                            <select class="form-select @error('platform') is-invalid @enderror" 
                                    id="platform" name="platform" required>
                                <option value="">Select Platform</option>
                                <option value="zoom" {{ old('platform', $class->platform) == 'zoom' ? 'selected' : '' }}>
                                    Zoom
                                </option>
                                <option value="google_meet" {{ old('platform', $class->platform) == 'google_meet' ? 'selected' : '' }}>
                                    Google Meet
                                </option>
                                <option value="microsoft_teams" {{ old('platform', $class->platform) == 'microsoft_teams' ? 'selected' : '' }}>
                                    Microsoft Teams
                                </option>
                                <option value="youtube" {{ old('platform', $class->platform) == 'youtube' ? 'selected' : '' }}>
                                    YouTube Live
                                </option>
                                <option value="other" {{ old('platform', $class->platform) == 'other' ? 'selected' : '' }}>
                                    Other
                                </option>
                            </select>
                            @error('platform')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control @error('meeting_url') is-invalid @enderror" 
                                   id="meeting_url" name="meeting_url" value="{{ old('meeting_url', $class->meeting_url) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('meeting_id') is-invalid @enderror" 
                                       id="meeting_id" name="meeting_id" value="{{ old('meeting_id', $class->meeting_id) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('duration_minutes') is-invalid @enderror" 
                                ...
                                <option value="15" {{ old('duration_minutes', $class->duration) == 15 ? 'selected' : '' }}>15 minutes</option>
                                <option value="30" {{ old('duration_minutes', $class->duration) == 30 ? 'selected' : '' }}>30 minutes</option>
                                <option value="45" {{ old('duration_minutes', $class->duration) == 45 ? 'selected' : '' }}>45 minutes</option>
                                <option value="60" {{ old('duration_minutes', $class->duration) == 60 ? 'selected' : '' }}>1 hour</option>
                                <option value="90" {{ old('duration_minutes', $class->duration) == 90 ? 'selected' : '' }}>1.5 hours</option>
                                <option value="120" {{ old('duration_minutes', $class->duration) == 120 ? 'selected' : '' }}>2 hours</option>
                                <option value="180" {{ old('duration_minutes', $class->duration) == 180 ? 'selected' : '' }}>3 hours</option>
                            </select>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="auto_record" name="auto_record" value="1" 
                                       {{ old('auto_record', $class->auto_record) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3">
                            <a href="{{ route('tenant.teacher.classroom.virtual.show', $class) }}" class="btn btn-outline-secondary">

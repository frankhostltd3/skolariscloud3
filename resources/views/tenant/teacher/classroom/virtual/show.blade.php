        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group">
                @if ($class->status === 'scheduled')
                    ...
                    <form action="{{ route('tenant.teacher.classroom.virtual.start', $class) }}" method="POST"
                        class="d-inline">
                        @csrf
                ...
                @elseif($class->status === 'ongoing')
                    <form action="{{ route('tenant.teacher.classroom.virtual.end', $class) }}" method="POST"
                        class="d-inline">
                        @csrf
                ...
                @endif
                @if ($class->status === 'scheduled')
                    <form action="{{ route('tenant.teacher.classroom.virtual.cancel', $class) }}" method="POST"
                        class="d-inline">
                        @csrf
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-muted">{{ $record->student->email }}</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <div class="card-body">
                        <div class="mb-3 pb-3 border-bottom">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <strong class="fs-4">{{ $class->class->students->count() ?? 0 }}</strong>
                            </div>
                        </div>
                        @if ($attendanceRecords->count() > 0)
                            <div class="mb-3 pb-3 border-bottom">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            @endif
                            <a href="{{ route('tenant.teacher.classroom.materials.index', ['class_id' => $class->id]) }}"
                                class="btn btn-outline-secondary">
                                <i class="bi bi-file-earmark-text me-1"></i> Add Materials
                            </a>
                            <a href="{{ route('tenant.teacher.classroom.exercises.index', ['class_id' => $class->id]) }}"
                                class="btn btn-outline-secondary">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('tenant.teacher.classroom.virtual.destroy', $class) }}" method="POST"
                        class="d-inline">
                        @csrf
                        @method('DELETE')

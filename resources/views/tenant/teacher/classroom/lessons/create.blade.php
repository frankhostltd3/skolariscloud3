        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-3">What should students know or be able to do by the end of this lesson?</p>
                                ...
                                @foreach(old('objectives') as $index => $objective)
                                    <div class="objective-item mb-2">
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-danger remove-objective" title="Remove">
                                    ...
                                    <div class="material-item mb-2">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="materials_needed[]" 
                                                   value="{{ $material }}" placeholder="e.g., Textbook, Whiteboard, Projector">
                                            <button type="button" class="btn btn-outline-danger remove-material" title="Remove">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('introduction') is-invalid @enderror" 
                                      ...
                                      placeholder="How will you engage students and introduce the topic?">{{ old('introduction') }}</textarea>
                            @error('introduction')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('main_content') is-invalid @enderror" 
                                      id="main_content" name="main_content" rows="6" 
                                      placeholder="Describe the main teaching activities and content delivery">{{ old('main_content') }}</textarea>
                            @error('main_content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted small mb-3">What will students do to practice or apply what they've learned?</p>
                                        ...
                                        <div class="activity-item mb-2">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="activities[]" 
                                                       value="{{ $activity }}" placeholder="Describe student activity">
                                                <button type="button" class="btn btn-outline-danger remove-activity" title="Remove">
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('assessment') is-invalid @enderror" 
                                      id="assessment" name="assessment" rows="3" 
                                      placeholder="How will you check student understanding?">{{ old('assessment') }}</textarea>
                            @error('assessment')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('homework') is-invalid @enderror" 
                                      ...
                                      placeholder="What should students do to reinforce or extend their learning?">{{ old('homework') }}</textarea>
                            @error('homework')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                  ...
                                  placeholder="Any additional notes, differentiation strategies, or reflection points">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="is_template" 
                                   name="is_template" value="1" {{ old('is_template') ? 'checked' : '' }}>
                        ...
                        <div class="alert alert-info mb-0">
                            <small>
                                ...
                                <strong>Published:</strong> Ready to teach<br>
                                <strong>Completed:</strong> Already taught
                            </small>
                        </div>
                    </div>
                </div>
...
@push('styles')
<style>
.objective-item, .material-item, .activity-item {
    transition: all 0.3s ease;
}

.objective-item:hover, .material-item:hover, .activity-item:hover {
    background-color: #f8f9fa;
    padding: 0.25rem;
    border-radius: 0.25rem;
}

.remove-objective, .remove-material, .remove-activity {
    transition: all 0.2s ease;
}

.remove-objective:hover, .remove-material:hover, .remove-activity:hover {
    transform: scale(1.1);
}
</style>
@endpush

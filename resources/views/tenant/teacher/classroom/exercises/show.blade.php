...
@section('content')
    <div class="container-fluid">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <div class="progress" style="height: 30px;">
                        ...
                        @endphp
                        <div class="progress-bar bg-success" role="progressbar" style="width: {{ $submittedPercent }}%"
                        ...
                        <div class="progress-bar bg-secondary" role="progressbar"
                            style="width: {{ $notSubmittedPercent }}%" aria-valuenow="{{ $notSubmittedPercent }}"
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h6 class="text-muted mb-0">Assignment Content & Questions</h6>
                                <span class="badge bg-light text-dark">Visible to students</span>
                            </div>
                            @if ($exercise->content)
                                <div id="assignment-content" class="wysiwyg-output border p-3 rounded">
                                    {!! $exercise->content !!}
                                </div>
                                <p class="small text-muted mt-2 mb-0">
                                    Use the Heading 2/3 buttons in the editor to generate the outline cards automatically.
                                </p>
                            @else
                                <div class="alert alert-light border">
                                    <i class="bi bi-exclamation-circle me-2"></i>No assignment content has been added yet.
                                    Students currently only see the overview and instructions.
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">
                                    <i
                                        class="bi bi-calendar-event me-2"></i>{{ $exercise->due_date->format('F j, Y g:i A') }}
                                </p>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">
                                    @if ($exercise->allow_late_submission)
                                        ...
                                        @if ($exercise->late_penalty_percent > 0)
                                            <span class="text-muted small">({{ $exercise->late_penalty_percent }}%
                                                penalty)</span>
                                        @endif
                                    @else
                ...
                @if ($recentSubmissions->count() > 0)
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                            <h5 class="mb-0"><i class="bi bi-clock-history me-2 text-primary"></i>Recent Submissions
                            </h5>
                            <a href="{{ route('tenant.teacher.classroom.exercises.submissions', $exercise) }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <div class="fw-medium">{{ $submission->student->full_name }}
                                                            </div>
                                                            <small
                                                                class="text-muted">{{ $submission->student->email }}</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white border-bottom">
                        <h6 class="mb-0"><i class="bi bi-list-ol me-2 text-primary"></i>Assignment Outline</h6>
                    </div>
                    <div class="card-body">
                        <p class="small text-muted">Students will see the same outline below.</p>
                        <ul class="list-unstyled small mb-0" id="assignment-outline"></ul>
                        <div class="text-muted small mb-0" id="assignment-outline-empty">
                            Add Heading 2/3 blocks inside the Assignment Content editor to auto-build a question outline for
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if ($stats['submitted'] == 0)
                        <form action="{{ route('tenant.teacher.classroom.exercises.destroy', $exercise) }}"
    ...
    @push('scripts')
        <script>
            window.buildAssignmentOutline = window.buildAssignmentOutline || function(contentId, listId, emptyId) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                window.buildAssignmentOutline('assignment-content', 'assignment-outline', 'assignment-outline-empty');
            });
        </script>
    @endpush
@endsection

    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button">
                <i class="bi bi-list me-2"></i>All Assignments
            </button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending" type="button">
                <i class="bi bi-exclamation-circle me-2"></i>Pending Review
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="graded-tab" data-bs-toggle="tab" data-bs-target="#graded" type="button">
                <i class="bi bi-check-circle me-2"></i>Graded
            </button>
        </li>
    </ul>
        ...
        <div class="tab-pane fade show active" id="all">
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="mt-3 text-muted">No Assignments Created</h5>
                    <p class="text-muted mb-4">Create your first assignment for students</p>
                    <a href="{{ route('tenant.teacher.classroom.exercises.create') }}" class="btn btn-primary">
        ...
        <div class="tab-pane fade" id="pending">
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="mt-3 text-muted">No Submissions Pending Review</h5>
                    <p class="text-muted">Student submissions will appear here for grading</p>
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="graded">
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <h5 class="mt-3 text-muted">No Graded Assignments</h5>
                </div>
            </div>
        </div>
    </div>

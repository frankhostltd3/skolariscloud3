    ...
    <div class="row">
                    ...
                    <form action="{{ route('tenant.teacher.classroom.exercises.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @error('instructions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Provide clear, step-by-step instructions for completing this assignment.</div>
                        </div>
                        ...
                        <div class="card bg-light mb-3">
                            <div class="card-body">
                                <h6 class="mb-3"><i class="bi bi-clock-history me-2"></i>Late Submission Settings</h6>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm bg-light mb-4">
                <div class="card-body">
                    <h6 class="mb-3"><i class="bi bi-lightbulb me-2 text-warning"></i>Tips for Creating Assignments</h6>
                    <ul class="small mb-0 ps-3">
                        <li class="mb-2"><strong>Clear Title:</strong> Use descriptive titles (e.g., "Math Chapter 5 Problems")</li>
                        <li class="mb-2"><strong>Instructions:</strong> Be specific about what students need to do</li>
                        <li class="mb-2"><strong>Due Date:</strong> Give students enough time to complete the work</li>
                        <li class="mb-2"><strong>Submission Type:</strong> Choose based on assignment requirements</li>

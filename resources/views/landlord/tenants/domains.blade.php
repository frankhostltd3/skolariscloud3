...
@section('content')
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-5">
        <div>
            <span
                class="badge text-bg-primary-subtle text-primary-emphasis px-3 py-2 mb-3">{{ __('Domain management') }}</span>
            <h1 class="h3 fw-semibold mb-2">{{ __('Add and manage custom domains for tenants') }}</h1>
            <p class="text-secondary mb-0">
                {{ __('Provision branded domains, configure DNS, and submit purchase requests on behalf of tenants.') }}</p>
        </div>
        ...
        <div class="col-12 col-xl-8">
            <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="domain-wizard-stepper" aria-label="{{ __('Domain purchase steps') }}">
                        <div class="domain-wizard-step" data-step="1">
                            ...
                            <div>
                                ...
                                <small
                                    class="text-secondary">{{ __('Search availability and choose billing cycle') }}</small>
                            </div>
                        </div>
                        <div class="domain-wizard-step" data-step="2">
                            ...
                            <div>
                                ...
                                <small
                                    class="text-secondary">{{ __('Attach tenant, provide contact, preview DNS records') }}</small>
                            </div>
                        </div>
                        <div class="domain-wizard-step" data-step="3">
                            ...
                            <div>
                                ...
                                <small
                                    class="text-secondary">{{ __('Confirm order, select payment, agree to terms') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-lg-5">
                    <form id="domain-wizard" class="domain-wizard" method="POST"
                        action="{{ route('landlord.domains.orders.store') }}" novalidate>
                        @csrf

                        <section class="domain-wizard-pane" data-step="1">
                            <div class="mb-4">
                                <h2 class="h5 fw-semibold mb-2">
                                    {{ __('What type of domain would you like to provision?') }}</h2>
                                <p class="text-secondary mb-0">
                                    {{ __('Use subdomains for quick onboarding or purchase a fully custom domain to match the school brand.') }}
                                </p>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <label class="domain-option-card">
                                        <input type="radio" name="domain_type" value="subdomain" class="form-check-input"
                                            checked>
                                        <div class="domain-option-card__body">
                                            ...
                                            <p class="text-secondary small mb-0">
                                                {{ __('Launch instantly with *.skolariscloud.com addresses. SSL, routing, and renewals handled for you.') }}
                                            </p>
                                ...
                                <div class="col-md-6">
                                    <label class="domain-option-card">
                                        ...
                                        <div class="domain-option-card__body">
                                            ...
                                            <p class="text-secondary small mb-0">
                                                {{ __('Register or transfer a personalised domain and keep billing consolidated under your landlord account.') }}
                                            </p>
                                            <div class="domain-option-card__price mt-3">
                            ...
                            <div class="row g-3 align-items-end">
                                <div class="col-md-7">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="desired-domain" name="desired_domain" class="form-control"
                                            placeholder="example" required>
                                        <select name="tld" class="form-select"
                                            aria-label="{{ __('Top level domain') }}">
                                    ...
                                    <small
                                        class="text-secondary d-block mt-2">{{ __('Search results update instantly – we’ll reserve the domain for 15 minutes after checkout.') }}</small>
                                </div>
                                <div class="col-md-5">
                            ...
                            <div class="alert alert-info mt-4 mb-0" role="status">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 small">
                                            {{ __('We will automatically provision certificates, CDN caching, and tenant routing rules once the domain goes live.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section class="domain-wizard-pane" data-step="2" hidden>
                            <div class="mb-4">
                                ...
                                <p class="text-secondary mb-0">
                                    {{ __('Specify which school will use this domain and who will receive DNS verification emails.') }}
                                </p>
                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <select id="tenant-id" name="tenant_id" class="form-select" required>
                                        ...
                                        @forelse ($tenants as $tenant)
                                            <option value="{{ $tenant['id'] }}">{{ $tenant['name'] }} @if ($tenant['admin_email'])
                                                    — {{ $tenant['admin_email'] }}
                                                @endif
                                            </option>
                                        @empty
                            ...
                            <div class="card border border-dashed rounded-4 mt-4">
                                <div class="card-body">
                                    <div
                                        ...
                                        <div>
                                            <h3 class="h6 fw-semibold mb-1">{{ __('DNS records preview (generated)') }}
                                            </h3>
                                            <p class="text-secondary small mb-0">
                                                {{ __('Share these with the person managing the domain. Records activate once the order is approved.') }}
                                            </p>
                                        </div>
                                        <button type="button"
                                            class="btn btn-outline-secondary btn-sm">{{ __('Copy records') }}</button>
                                    </div>
                                    ...
                                    <div class="table-responsive mt-3">
                                        <table class="table table-sm align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><span
                                                            class="badge text-bg-primary-subtle text-primary-emphasis">CNAME</span>
                                                    </td>
                                                    <td>@</td>
                                                ...
                                                <tr>
                                                    <td><span
                                                            class="badge text-bg-primary-subtle text-primary-emphasis">TXT</span>
                                                    </td>
                                                    <td>@</td>
                        ...
                        <section class="domain-wizard-pane" data-step="3" hidden>
                            <div class="mb-4">
                                ...
                                <p class="text-secondary mb-0">
                                    {{ __('Confirm billing details, add purchase notes, and authorise payment routing.') }}
                                </p>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    <div class="order-summary-card">
                                        ...
                                        <small
                                            class="text-secondary d-block mt-2">{{ __('Final pricing confirmed by support before charge is applied.') }}</small>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label class="form-label"
                                                for="billing-entity">{{ __('Billing entity / organisation') }}</label>
                                            <input type="text" class="form-control" id="billing-entity"
                                                name="billing_entity" placeholder="{{ __('Skolaris Cloud Ltd.') }}"
                                                required>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label"
                                                for="payment-method">{{ __('Preferred payment channel') }}</label>
                                        ...
                                        <div class="col-12">
                                            <label class="form-label"
                                                for="purchase-notes">{{ __('Purchase notes') }}</label>
                                            <textarea id="purchase-notes" name="purchase_notes" class="form-control" rows="3"
                                                placeholder="{{ __('E.g. include wildcard SSL, coordinate go-live during school holidays...') }}"></textarea>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="terms">
                                                    {!! __(
                                                        'I authorise Skolaris to purchase and renew this domain on behalf of the tenant and agree to the <a href=":url" target="_blank">Domain Services Terms</a>.',
                                                        ['url' => route('home') . '#terms'],
                                                    ) !!}
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div class="domain-wizard-actions">
                            ...
                            <div class="ms-auto d-flex gap-2">
                                <button type="button" class="btn btn-outline-primary domain-wizard-save"
                                    data-bs-toggle="tooltip" title="{{ __('Save current progress for later') }}">
                    ...
                    <ol class="domain-timeline">
                        <li>
                            ...
                            <div>
                                ...
                                <p class="text-secondary small mb-0">
                                    {{ __('We verify availability, confirm total pricing, and reserve the domain immediately.') }}
                                </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                ...
                                <p class="text-secondary small mb-0">
                                    {{ __('We guide the nominated contact through DNS changes or handle it entirely if delegated to us.') }}
                                </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                ...
                                <p class="text-secondary small mb-0">
                                    {{ __('SSL, routing, uptime checks, and renewal reminders are automated from your landlord console.') }}
                                </p>
                            </div>
                        </li>
                    </ol>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="text-secondary small mb-3">
                        {{ __('Speak with our domain onboarding specialists for DNS assistance or bulk domain purchases.') }}
                    </p>
                    <div class="d-flex flex-column gap-2">
                        <a href="mailto:domains@skolariscloud.com" class="btn btn-outline-primary btn-sm"><span
                                class="bi bi-envelope me-2"></span>{{ __('Email domains team') }}</a>
                        <a href="https://cal.com/skolaris/domains" target="_blank"
                            class="btn btn-outline-secondary btn-sm"><span
                                class="bi bi-calendar-event me-2"></span>{{ __('Schedule a call') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const validateStep = () => {
                    ...
                    const inputs = [...pane.querySelectorAll('input, select, textarea')].filter(el => el
